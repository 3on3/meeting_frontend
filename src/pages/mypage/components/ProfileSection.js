        ...
        <div className={styles.firstContents}>
          ...
          <div>
            <img
              ...
              className={`${styles.pencil} ${isEditingName ? styles.isEditing : ""}`}
        ...
        <div className={styles.secondContents}>
          ...
          <div>
            <img
              ...
              className={`${styles.pencil} ${isEditingDescription ? styles.isEditing : ""}`}
        ...
        <div className={styles.thirdContents}>
          ...
          <div>
            <img
              ...
              className={`${styles.pencil} ${isEditingMajor ? styles.isEditing : ""}`}
