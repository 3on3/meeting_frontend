...
const DEFAULT_PROFILE_IMG_URL = "https://spring-file-bucket-yocong.s3.ap-northeast-2.amazonaws.com/2024/default_profile.png";
...
const FirstLoginPage = () => {
  ...
  return (
    <>
      {step === 1 && isProfileImageValid && <FirstLoginProfile nextHandler={nextStepHandler} />}
